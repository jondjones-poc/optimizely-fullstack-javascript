...
const ComponentA = ({...props}) => {
    ...
    return (
        <div className="container" id="component-a">
            ...
            <div className="row aln-center" id="component-a-row">
                <div className="col-4 col-6-medium col-12-small" id="component-a-header">
                    <section>
                ...
                <div className="wrapped" id="component-a-body">
                    <div className="col-4 col-6-medium col-12-small" id="component-a-item-one">
                        <section>
                    ...
                    <div className="col-4 col-6-medium col-12-small" id="component-a-item-two">
                        <section>
                    ...
                    <div className="col-12" id="component-a-footer">
