...
export default function Home({...props}) {
  ...
  // Gat user Id either via query string, or, create a random one
    ...
    <>
      ...
      <section id="main">
        ...
        <article className="box post">
          ...
          <a href="#" className="image featured"><img src={`./images/${postData.id}.png`} alt={postData.title} /></a>
          <p>{postData.body}</p>
